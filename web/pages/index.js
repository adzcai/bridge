      ...
      <div className="is-preload">
        ...
        <article className="container box style2">
          ...
          <div className="inner gallery">
            ...
            <div className="row gtr-0">
              <div className="col-3 col-12-mobile thumb"><a href="/images/fulls/05.jpg" className="image fit"><img src="/images/thumbs/05.jpg" alt="" title="Cherish" /></a></div>
              <div className="col-3 col-12-mobile thumb"><a href="/images/fulls/06.jpg" className="image fit"><img src="/images/thumbs/06.jpg" alt="" title="Different." /></a></div>
              <div className="col-3 col-12-mobile thumb"><a href="/images/fulls/07.jpg" className="image fit"><img src="/images/thumbs/07.jpg" alt="" title="History was made here" /></a></div>
              <div className="col-3 col-12-mobile thumb"><a href="/images/fulls/08.jpg" className="image fit"><img src="/images/thumbs/08.jpg" alt="" title="People come and go and walk away" /></a></div>
            </div>
          </div>
        </article>
